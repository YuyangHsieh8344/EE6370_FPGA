...
const int nk=4;                               /* 4,6,8(128,192,256 bits)*/
const int nr=10; //nk+6;               /* 10,12,14 */
...
int SubWord(int);                  /* FIPS 197  P.20 Figure 11 */ /* FIPS 197  P.19  5.2 */
int RotWord(int);                  /* FIPS 197  P.20 Figure 11 */ /* FIPS 197  P.19  5.2 */
void KeyExpansion(unsigned char *);            /* FIPS 197  P.20 Figure 11 */
